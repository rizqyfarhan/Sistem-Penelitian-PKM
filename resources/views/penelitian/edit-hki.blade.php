...
<body class="sb-nav-fixed d-flex flex-column h-100">
    <h1 class="text-center mb-4">Edit HKI Penelitian</h1>
    ...
    <div class="row justify-content-center mt-5">
        <div class="col-lg-8">
            <div class="card mb-4">
                <div class="card-body">
                    <div class="container">
                        <form action="{{ route('update.hkipenelitian', $hki_penelitian->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                <div class=" form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" id="judul" name="judul"
                                        value="{{ old('judul', $hki_penelitian->judul) }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class=" form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" id="nama_pemegang" name="nama_pemegang"
                                        value="{{ old('nama_pemegang', $hki_penelitian->nama_pemegang) }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class=" form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" id="nomor_sertifikat"
                                        ...
                                        value="{{ old('nomor_sertifikat', $hki_penelitian->nomor_sertifikat) }}">
                                </div>
                            </div>

                            <div class="form-group mb-2">
                                <label for="file">HKI Penelitian:</label>
                                <input type="file" class="form-control" id="file" name="file">
                                @if($hki_penelitian->file)
                                <p class="mt-2">Current File: {{ $hki_penelitian->file }}</p>
                                @endif
                            </div>
