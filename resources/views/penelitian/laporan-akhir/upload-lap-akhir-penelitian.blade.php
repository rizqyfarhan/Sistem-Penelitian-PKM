...
<div class="nav-scroller py-1 mb-3 border-bottom">
    <nav class="nav nav-underline justify-content-start">
        ...
        <a class="nav-item nav-link link-body-emphasis" href="/lihat-lap-akhir-penelitian">Upload Saya</a>
    </nav>
</div>
    ...
    <div class="card-body">
        <div class="container">
            <form action="{{ route('lapakhpenelitian.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="AnggotaSatu">Anggota Peneliti 1:</label>
                    <input type="text" class="form-control" id="AnggotaSatu" name="peneliti_satu">
                </div>

                <div class="form-group">
                    <label for="nidn_1">NIDN:</label>
                    <input type="text" class="form-control" id="nidn_1" name="nidn_peneliti_satu">
                </div>

                <div class="form-group">
                    <label for="nrk_1">NRK:</label>
                    <input type="text" class="form-control" id="nrk_1" name="nrk_peneliti_satu">
                </div>

                <div class="form-group">
                    <label for="AnggotaDua">Anggota Peneliti 2:</label>
                    <input type="text" class="form-control" id="AnggotaDua" name="peneliti_dua">
                </div>

                <div class="form-group">
                    <label for="nidn_2">NIDN:</label>
                    <input type="text" class="form-control" id="nidn_2" name="nidn_peneliti_dua">
                </div>

                <div class="form-group">
                    <label for="nrk_2">NRK:</label>
                    <input type="text" class="form-control" id="nrk_2" name="nrk_peneliti_dua">
                </div>
