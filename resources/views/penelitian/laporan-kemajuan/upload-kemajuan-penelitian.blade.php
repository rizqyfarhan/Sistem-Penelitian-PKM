...
<div class="nav-scroller py-1 mb-3 border-bottom">
    <nav class="nav nav-underline justify-content-start">
        <a class="nav-item nav-link link-body-emphasis active" href="/upload-kemajuan-penelitian">Upload</a>
        <a class="nav-item nav-link link-body-emphasis" href="/lihat-kemajuan-penelitian">Upload Saya</a>
    </nav>
</div>
        ...
        <div class="container">
            <form action="{{ route('lapkempenelitian.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="JudulPKM">Judul Penelitian:</label>
                    <input type="text" class="form-control" id="JudulPKM" name="judul_penelitian" required>
                </div>

                <div class="form-group">
                    <label for="NamaPelaksana">Nama Peneliti:</label>
                    <input type="text" class="form-control" id="NamaPelaksana" name="nama_peneliti">
                </div>
