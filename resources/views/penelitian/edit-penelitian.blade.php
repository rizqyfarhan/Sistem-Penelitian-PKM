...
<body class="sb-nav-fixed d-flex flex-column h-100">
    ...
    <div class="card mb-4">
        <div class="card-body px-4">
            <div class="container">
                <form action="{{ route('update.proposalpenelitian', $proposal->id) }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="SumberDana" name="sumber_dana"
                            onchange="toggleLembagaPendana()" value="{{ old('sumber_dana', $proposal->sumber_dana) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="LembagaPendana" name="lembaga_pendana"
                            value="{{ old('lembaga_pendana', $proposal->lembaga_pendana) }}">
                    </div>
