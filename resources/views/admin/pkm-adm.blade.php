...
<div class="nav-scroller py-1 mb-3 border-bottom">
    <nav class="nav nav-underline justify-content-start">
        <a class="nav-item nav-link link-body-emphasis active" href="{{ route('upload.proposalpkmadmin') }}">Upload</a>
        <a class="nav-item nav-link link-body-emphasis" href="{{ route('index.proposalpkmadmin') }}">Upload Saya</a>
    </nav>
</div>
...
<div class="card mb-4">
    <div class="card-body">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="container">
                    <form action="{{ route('store.akhirpkm') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="JudulPKM">Judul PKM:</label>
                            <select class="form-control" id="JudulPKM" name="judul" required>
