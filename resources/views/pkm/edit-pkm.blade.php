...
<body class="sb-nav-fixed d-flex flex-column h-100">
    <h1 class="text-center">Edit Proposal PKM</h1>

    <div class="card mb-4">
        <div class="card-body px-4">
            <div class="container">
                <form action="{{ route('update.proposalpkm', $proposal->id) }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <label for="JudulPKM">Judul PKM:</label>
                        <input type="text" class="form-control" id="JudulPKM" name="judul"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="NamaPelaksana" name="nama_pelaksana"
                            value="{{ old('nama_pelaksana', $proposal->nama_pelaksana) }}">
                    </div>
                    <div class="form-group">
